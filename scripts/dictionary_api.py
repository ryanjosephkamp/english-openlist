...
class DictionaryAPIClient:
    ...
    Uses Merriam-Webster as primary, Free Dictionary as fallback.
    """
    ...
    async def lookup_word(
        ...
        # Use fallback if MW didn't find it and fallback is enabled
        if use_fallback and result.status == WordStatus.NOT_FOUND:
            logger.debug(f"MW didn't find '{word}', trying fallback")
